            ...
            <table class="table table-striped">
                ...
                @foreach($teacher_absents as $teacher_absent)
                    <tr>
                        ...
                        <td>
                            @if($check_power['d'])
                                <button onclick="if(confirm('您確定送出嗎?')) location.href='/teacher_absents/check/check1/{{ $teacher_absent->id }}';else return false">同意</button>
                            @endif
                        </td>
                        <td>
                            @if($check_power['a'])
                        ...
                        <td>
                            @if($check_power['b'])
                                <button onclick="if(confirm('您確定送出嗎?')) location.href='/teacher_absents/check/check1/{{ $teacher_absent->id }}';else return false">記錄</button>
                            @endif
                        </td>
                        <td>
                            @if($check_power['e'])
                                <button onclick="if(confirm('您確定送出嗎?')) location.href='/teacher_absents/check/check1/{{ $teacher_absent->id }}';else return false">已排代</button>
                            @endif
                        </td>
                    </tr>
                @endforeach
