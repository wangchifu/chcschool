...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <?php
    $active = ($p==1)?"active":null;        
    ?>
        <li class="nav-item">
            <a class="nav-link {{ $active }}" id="profile-tab" data-toggle="tab" href="#post_type2_profile{{ $p }}" role="tab" aria-controls="profile" aria-selected="false">{{ $post_type->name }}</a>
        </li>
        <?php $p++; ?>
    @endforeach
</ul>
<div class="tab-content" id="myTabContent">
    ...
    ?>
        <div class="tab-pane fade {{ $active }}" id="post_type2_profile{{ $p }}" role="tabpanel" aria-labelledby="profile-tab" style="margin: 10px;">
            <?php
            $p++;
