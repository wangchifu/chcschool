...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">一般公告</a>
    </li>
    <?php
        $p=1;
    ?>
    @foreach($post_types as $post_type)
        ...
        ?>
        <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile{{ $p }}" role="tab" aria-controls="profile" aria-selected="false">{{ $post_type->name }}</a>
        </li>
    @endforeach
</ul>
<div class="tab-content" id="myTabContent">
    ...
    ?>
    @foreach($post_types as $post_type)
        <div class="tab-pane fade" id="profile{{ $p }}" role="tabpanel" aria-labelledby="profile-tab" style="margin: 10px;">
            <?php
            $p++;
