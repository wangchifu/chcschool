            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <input type="text" name="year2_1" size="5" required maxlength="4" placeholder="4碼" value="{{ $d2_1['0'] }}">年
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <input type="text" name="year2_2" size="5" required maxlength="4" placeholder="4碼" value="{{ $d2_2['0'] }}">年
