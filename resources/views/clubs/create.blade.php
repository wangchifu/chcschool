            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <input type="text" name="year_1" size="3" required maxlength="4" placeholder="4碼">年
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <input type="text" name="year_2" size="3" required maxlength="4" placeholder="4碼">年
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <input type="text" name="year2_1" size="3" required maxlength="4" placeholder="4碼">年
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <input type="text" name="year2_2" size="3" required maxlength="4" placeholder="4碼">年
