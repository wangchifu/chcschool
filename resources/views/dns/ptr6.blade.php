@include('dns.header')
    ...
    <div class="container mb-5">
        ...
        <!-- IPv6 PTR 網段切換選單 -->
        @if(!empty($dns_data['ipv6_ptr']) && count($dns_data['ipv6_ptr']) > 0)
            <div class="mb-3 d-flex align-items-center gap-2 flex-wrap">
                <span class="fw-bold text-secondary">選擇管理的 IPv6 PTR 網段：</span>
                @foreach($dns_data['ipv6_ptr'] as $ptrZone)
                    <a href="{{ route('dns.ptr6', ['networkSubnet' => $ptrZone]) }}" 
